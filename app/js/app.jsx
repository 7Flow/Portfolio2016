...
class App  {
    ...
    static TRANSITION_END = 'transitionend oTransitionEnd webkitTransitionEnd';
    static IS_MOBILE = false;
    static IS_TACTILE = false;
    static IS_FIREFOX = false;
    static IS_IE = false;
    static IS_SAFARI = false;
    ...
    constructor() {
        this.header = new Header($.proxy(this.loadSection, this));
        ...
        $(document.body).on('popin:open', $.proxy(this.onPopinOpen, this))
                .on('popin:close', $.proxy(this.onPopinClose, this));
    ...
    sectionLoaded()
    {
        if (this.$previousSection) {
            ...
            this.$currentSection.on( App.TRANSITION_END, () => {
                this.$previousSection.removeClass('previous current');
                this.$currentSection.off(App.TRANSITION_END);
        ...
        setTimeout( ()=> {
            ...
            this.$loading.removeClass('animate').addClass('complete');
    ...
    intoTheNineties()
    {
        ...
        setTimeout( () => {
            this.header.goBackToNineties();
            this.footer.goBackToNineties();
        }, 100);
